...
<div align="center">
  <img src="https://img.shields.io/badge/Total_Score-33%2F100-critical?style=for-the-badge&logo=codecov" alt="Total Score"/>
  <img src="https://img.shields.io/badge/Status-NEEDS_WORK-black?style=for-the-badge" alt="Status"/>
  <img src="https://img.shields.io/badge/Technical_Depth-25-purple?style=for-the-badge" alt="Tech Depth"/>
</div>

| Attribute           | Value                                 |
| :------------------ | :------------------------------------ |
| **Student**         | `Atahan Turna` (`2420191030`) |
| **Course**          | `secure-web`                       |
...
pie title Grading Distribution Analysis (Earned vs Maximum Target)
    "Technical Depth (25%)" : 6
    "Functional Testing (30%)" : 0
    "Commit Activity (10%)" : 4
    "Code Quality (10%)" : 8
    "Documentation (10%)" : 4
    "Repo Discipline (10%)" : 1
    "Time Investment (5%)" : 2
```

| Metric Area            |      Awarded       | Weight Max | Grading Logic Analogy                                                   |
| :--------------------- | :----------------: | :--------: | :---------------------------------------------------------------------- |
| **Technical Depth**    | `25`  |     25     | _(Röntgen Analizi)_ Deep structural / architectural execution.          |
...
| **Documentation**      |  `40`  |     10     | Readme, architecture diagrams, installation instructions.               |
| **Repo Discipline**    |  `10`  |     10     | Proper directory structure, `.gitignore`, CI/CD, dependency management. |
